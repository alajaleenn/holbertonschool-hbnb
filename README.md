...
## Description
HBNB is a project that aims to clone Airbnb.
It focuses on building a complete property rental management system with a scalable architecture, starting from a command-line interface and evolving into a dynamic web application connected to a database.
